...
void
ImgWindow::drawWindowCB(XPLMWindowID /* inWindowID */inWindowID, void *inRefcon) {
...
int
ImgWindow::handleMouseClickCB(XPLMWindowID /* inWindowID */inWindowID, int x, int y, XPLMMouseStatus inMouse,
                              void *inRefcon) {
    auto *thisWindow = reinterpret_cast<ImgWindow *>(inRefcon);
...
int
ImgWindow::handleRightClickFuncCB(XPLMWindowID /* inWindowID */inWindowID, int x, int y, XPLMMouseStatus inMouse,
                                  void *inRefcon) {
    auto *thisWindow = reinterpret_cast<ImgWindow *>(inRefcon);
